...
void fit_mc_bg_to_data_loop_constrained() {
    ...
    int vPbmax = 400;
    int SSBbins = 60;
    int SSBmin = 1400; // 1400; (M10) 900; (M12)
    int SSBmax = 2000; // 2000; (M10) 1500; (M12)
    int NLLbins = 100;
    int NLLmin = -20;
    int NLLmax = -10;
    ...
    int vDnum = 581 * 0.987452;     // 627; // (M10) // std::round(627 * (98.24 / 98.83)); // (M12)
    int vOnum = 95 * 0.897703;      // 114; // (M10) // std::round(114 * (80.36 / 83.28)); // (M12)
    int BRNnum = 654 * 0.557747;    // 130; // (M10) // std::round(130 * (0.95 / 1.36)); // (M12)
    int vFenum = 501 * 0.287418;    // 132; // (M10) // 126; // (M12)
    int vPbnum = 17245 * 0.0231533; // 215; // (M10) // 175; // (M12)
    int SSBnum = 3550;              // 1679;
    ...
    std::filesystem::create_directory("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots");           // fitting_results/NLL_fits_with_vFe_and_vPb/plots");
    ...
    for (int iLoop = min_loop; iLoop < max_loop; iLoop++) {
        ...
        TFile *f1 = new TFile("RooFit_Code/sims/vD_Energy.root");
        if (!f1 || f1->IsZombie()) {
        ...
        ifstream ReadTextFile1("RooFit_Code/sims/vD_Time.txt");
        ...
        TFile *f2 = new TFile("RooFit_Code/sims/vO_Energy.root");
        if (!f2 || f2->IsZombie()) {
        ...
        // Read from the text file
        ifstream ReadTextFile2("RooFit_Code/sims/vO_Time.txt");
        ...
        TFile *f3 = new TFile("RooFit_Code/sims/BRN_Energy.root");
        if (!f3 || f3->IsZombie()) {
        ...
        // Read from the text file
        ifstream ReadTextFile3("RooFit_Code/sims/BRN_Time.txt");
        ...
        TFile *f4 = new TFile("RooFit_Code/sims/vFe_Energy.root");
        if (!f4 || f4->IsZombie()) {
        ...
        // Read from the text file
        ifstream ReadTextFile4("RooFit_Code/sims/vFe_Time.txt");
        ...
        TFile *f5 = new TFile("RooFit_Code/sims/vPb_Energy.root");
        if (!f5 || f5->IsZombie()) {
        ...
        // Read from the text file
        ifstream ReadTextFile5("RooFit_Code/sims/vPb_Time.txt");
        ...
        // Read from the first text file (_mult12 for multiplicity =12 version)
        ifstream ReadBackgroundFile("RooFit_Code/data/SSB_Time_And_Energy.txt");
        ...
        while (getline(ReadBackgroundFile, intval)) {
            ...
            if (num_vec[0] >= 0.0 && num_vec[0] <= 10000.0 && num_vec[1] > 30.0 && num_vec[1] <= 500.0) {
        ...
        // ===================================================================
        // LOAD REAL DATA HISTOGRAM: Unblinded Data (UB)
        // ===================================================================
        // cout << "\nLoading real data: Background Events..." << endl;

        // Read from the first text file (_mult12 for multiplicity =12 version)
        ifstream ReadUBDataFile("RooFit_Code/data/Unblinded_BeamSpill_Time_And_Energy.txt");

        // Use a while loop together with the getline() function to read the file line by line
        while (getline(ReadUBDataFile, intval)) {
            num_vec.clear();
            num_str.clear();
            intval.push_back('\t');
            for (char ch : intval) {           
        ...
        // Close the file
        ReadUBDataFile.close();
        ReadUBDataFile.clear();
        ...
        cout << "  weight_vFe = " << result.Parameter(2) << " +/- " << result.ParError(3) << endl;
        cout << "  weight_vPb = " << result.Parameter(3) << " +/- " << result.ParError(4) << endl;
        ...
        if (fit_method == 1) {
            ...
            ndf -= 4;  // Subtract number of fit parameters
            ...
            cout << "Number of parameters: 4" << endl;
            cout << "Effective NDF: " << (nbins_used - 4) << endl;
        ...
        if (iLoop == sample_loop) {
            ...
            c2->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/2D_Event_Rates.png");
            ...
            c3->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/MC_to_Data_Fit_Results-2D.png");
            ...
            h_vFe_time->SetTitle(Form("vFe Time (w=%.5f)", result.Parameter(2)));
            ...
            h_vPb_time->SetTitle(Form("vPb Time (w=%.5f)", result.Parameter(3)));
            ...
            c4->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/MC_Components.png");
            ...
            c6->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/1D_Plots.png");
            ...
            c7->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/Steady_State_Background.png");
            ...
            c9->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/Residual_Errors.png");
    ...
    c1->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/Interaction_Event_Rates.png");
    ...
    c8->SaveAs("/mnt/c/Users/eliwa/Documents/Detector_Data_Analysis/fitting_results/unblinded_results/plots/Recovered_Weight_Correlations.png");
